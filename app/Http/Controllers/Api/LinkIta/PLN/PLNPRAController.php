...
class PLNPRAController extends Controller
{
    ...
    public function Inq(Request $request)
    {
        ...
        $method = LKMethod::InqPLNPra;
        $kodeProduk = LKConstant::PLNPRA;
