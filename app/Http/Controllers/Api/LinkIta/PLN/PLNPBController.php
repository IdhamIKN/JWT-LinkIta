...
class PLNPBController extends Controller
{
    ...
    public function Inq(Request $request)
    {
        ...
        $method = LKMethod::InqPLNPB;
        $kodeProduk = LKConstant::PLNPB;
