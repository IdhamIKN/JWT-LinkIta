...
namespace App\Http\Controllers\Api\LinkIta\Asuransi;
...
class BPJSController extends Controller
{
    ...
    public function Inq(Request $request)
    {
        ...
        $method = LKMethod::BPJSInq;
        $kodeProduk = LKConstant::BPJS;
