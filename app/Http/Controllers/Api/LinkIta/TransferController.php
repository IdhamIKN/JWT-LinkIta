...
class TransferController extends Controller
{
    ...
    public function transferInqAndCheckInq(Request $request)
    {
        ...
        sleep(3);
            ...
            $log->signature = $Generate->generateSignature(env('CLIENT_KEY'), LKMethod::InqCheck, LKConstant::TFBank, date('Y-m-d H:i:s'), $checkInqRequest->id_pelanggan, env('ID_MEM'), $Generate->generateRef1());
    ...
    public function transferPayAndCheckPay(Request $request)
    {
        ...
        sleep(3);
            ...
            $log->signature = $Generate->generateSignature(env('CLIENT_KEY'), LKMethod::PayCheck, LKConstant::TFBank, date('Y-m-d H:i:s'), $checkPayRequest->id_pelanggan, env('ID_MEM'), $Generate->generateRef1());
