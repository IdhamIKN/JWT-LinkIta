...
Route::middleware(['auth:api', 'auth.api'])->group(function () {
    ...
    // PLN Pascabayar
    Route::post('/inqplnpb', [PLNPBController::class, 'InqPLNPB']);
    Route::post('/checkinqplnpb', [PLNPBController::class, 'InqPLNPBCek']);
    // Route::post('/inqplnpbcheck', [PLNController::class, 'transferInqAndCheckInq']);

    Route::post('/plnpbpay', [PLNPBController::class, 'PayPLNPB']);
    Route::post('/plnpbcheckpay', [PLNPBController::class, 'checkPayPLNPB']);
    // Route::post('/paytransfercheck', [PLNController::class, 'transferPayAndCheckPay']);

    // PLN Prabayar
    Route::post('/inqplnpra', [PLNPRAController::class, 'InqPLNPRA']);
    Route::post('/checkinqplnpra', [PLNPRAController::class, 'InqPLNPRACek']);
    // Route::post('/inqplnpbcheck', [PLNController::class, 'transferInqAndCheckInq']);

    Route::post('/plnprapay', [PLNPRAController::class, 'PayPLNPRA']);
    Route::post('/plnpracheckpay', [PLNPRAController::class, 'checkPayPLNPRA']);
    // Route::post('/paytransfercheck', [PLNController::class, 'transferPayAndCheckPay']);
